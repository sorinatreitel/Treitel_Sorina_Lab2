...
namespace Treitel_Sorina_Lab2.Models
{
    public class Member
    {
        ...
        [RegularExpression(@"^[0]\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{3})$", ErrorMessage = "Telefonul trebuie sa fie de forma si sa inceapa cu 0 '0722-123-123' sau'0722.123.123' sau '0722 123 123'")]
